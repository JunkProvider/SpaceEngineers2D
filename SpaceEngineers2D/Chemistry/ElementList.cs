...
namespace SpaceEngineers2D.Chemistry
{
    public class ElementList
    {
        ...
        public Element Hydrogen { get; } = new Element(
            ...
            heatCapacity: MolecularHeatCapacity.FromJoulePerMolTimesKelvin(28.836));
        ...
        public Element Carbon { get; } = new Element(
            ...
            classification: ElementClassification.NonMetal,
            heatCapacity: MolecularHeatCapacity.FromJoulePerMolTimesKelvin(8.517));
        ...
        public Element Oxygen { get; } = new Element(
            ...
            classification: ElementClassification.NonMetal,
            heatCapacity: MolecularHeatCapacity.FromJoulePerMolTimesKelvin(29.378 / 2));
        ...
        public Element Iron { get; } = new Element(
            ...
            heatCapacity: MolecularHeatCapacity.FromJoulePerMolTimesKelvin(25.10));
